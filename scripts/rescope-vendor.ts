...
function excluded(file: string): boolean {
  ...
  // The desktop app is not a workspace member: it consumes the harness as
  // published tarballs, so the upstream names it still carries are the peer
  // ranges those tarballs declare, a preset id, and a patch filename — none of
  // them references a package this rename owns.
